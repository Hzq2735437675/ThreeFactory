  ...
  */
  ...
  private initControl() {
    ...
    this.controls.addEventListener('change', ()=>{
      ...
      // Emit camera change event with camera information
      this.emitter.emit(Events.camera.change, this.getCameraInfo());
    });
  }

  /**
   * Get current camera information
   * @returns Camera position, rotation, and target information
   */
